...
public class DiseaseImmunityCondition implements Condition {

	public DiseaseImmunityCondition(List<Condition> allConditions) {
	...
	public ImageIds getImageIds() {
		return ImageIds.DISEASE_IMMUNITY_CONDITION;
	}
}
