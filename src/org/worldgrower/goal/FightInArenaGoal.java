...
public class FightInArenaGoal implements Goal {

	public FightInArenaGoal(List<Goal> allGoals) {
		allGoals.add(this);
	}
	...
	public boolean isGoalMet(WorldObject performer, World world) {
		Integer arenaOpponentId = performer.getProperty(Constants.ARENA_OPPONENT_ID);
		return arenaOpponentId == null || arenaOpponentId.intValue() == -1;
	...
	public FormattableText getDescription() {
		return new FormattableText(TextId.GOAL_FIGHT_IN_ARENA);
	}
