...
public class CreateFishingPoleGoal implements Goal {

	public CreateFishingPoleGoal(List<Goal> allGoals) {
		allGoals.add(this);
	}
	...
	public FormattableText getDescription() {
		return new FormattableText(TextId.GOAL_CREATE_FISHING_POLE, Item.FISHING_POLE);
	}
