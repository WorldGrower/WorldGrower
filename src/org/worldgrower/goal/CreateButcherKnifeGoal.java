...
import org.worldgrower.actions.ConstructButcherKnifeAction;
import org.worldgrower.generator.BuildingGenerator;
import org.worldgrower.generator.Item;
import org.worldgrower.text.FormattableText;
import org.worldgrower.text.TextId;

public class CreateButcherKnifeGoal implements Goal {

	public CreateButcherKnifeGoal(List<Goal> allGoals) {
		allGoals.add(this);
	}
	...
	public OperationInfo calculateGoal(WorldObject performer, World world) {
		...
		if (workbenchId == null) {
			...
			if (!ConstructButcherKnifeAction.hasEnoughWood(performer)) {
				return Goals.WOOD_GOAL.calculateGoal(performer, world);
			} else if (!ConstructButcherKnifeAction.hasEnoughOre(performer)) {
				return Goals.ORE_GOAL.calculateGoal(performer, world);
			} else {
				WorldObject workbench = world.findWorldObjectById(workbenchId);
				return new OperationInfo(performer, workbench, Args.EMPTY, Actions.CONSTRUCT_BUTCHER_KNIFE_ACTION);
			}
		}
	}
	...
	public FormattableText getDescription() {
		return new FormattableText(TextId.GOAL_CREATE_BUTCHER_KNIFE, Item.BUTCHER_KNIFE);
	}
