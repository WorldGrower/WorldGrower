...
public class CommonerGenerator implements Serializable {
	...
	public static int generateSkeletalRemains(WorldObject originalWorldObject, World world) {
		...
		properties.put(Constants.DEATH_INFORMATION, new DeathInformation(originalWorldObject, world));
	...
	private static void unmarkSellableWorldObjects(WorldObject creature) {
		...
		inventory.iterate((item, index) -> item.removeProperty(Constants.SELLABLE));
	}
