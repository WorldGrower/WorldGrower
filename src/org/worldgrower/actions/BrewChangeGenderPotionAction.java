...
public class BrewChangeGenderPotionAction implements CraftAction, AnimatedAction {
	...
	private static final int OIL_REQUIRED = 5;
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.CHANGE_GENDER_POTION.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "Change gender potion changes a person's gender if ingested";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "brewing a change gender potion";
	}
	...
	public ImageIds getImageIds(WorldObject performer) {
		return ImageIds.CHANGE_GENDER_POTION;
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.CHANGE_GENDER_POTION_ANIMATION;
	}
