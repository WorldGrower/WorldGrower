...
public class CraftSteelBootsAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.STEEL_BOOTS.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "steel boots are used as armor to reduce the damage taken from attacks";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting steel boots";
	}

	@Override
	public String getSimpleDescription() {
		return "craft steel boots";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_BOOTS_ANIMATION;
	}
