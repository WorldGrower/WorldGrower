...
public class CraftSteelHelmetAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.STEEL_HELMET.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "a steel helmet is used as armor to reduce the damage taken from attacks";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting steel helmet";
	}

	@Override
	public String getSimpleDescription() {
		return "craft steel helmet";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_HELMET_ANIMATION;
	}
