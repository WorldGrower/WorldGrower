...
public class CraftIronMorningstarAction implements CraftEquipmentAction, AnimatedAction {
	...
	public String getDescription() {
		return "an iron morningstar is used as a weapon";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting iron morningstar";
	}
	...
	public ImageIds getImageIds(WorldObject performer) {
		return ImageIds.IRON_MORNINGSTAR;
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.IRON_MORNINGSTAR_ANIMATION;
	}
