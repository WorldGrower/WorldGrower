...
public class CraftIronTridentAction implements CraftEquipmentAction, AnimatedAction {
	...
	public String getDescription() {
		return "an iron trident is used as a weapon";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.IRON_TRIDENT_ANIMATION;
	}
