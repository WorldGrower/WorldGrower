...
public class FeatherAction implements MagicSpell, AnimatedAction {
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "casting feather on " + target.getProperty(Constants.NAME);
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.FEATHER_MAGIC_SPELL_ANIMATION;
	}
