...
public class CraftSteelGreataxeAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.STEEL_GREATAXE.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "a steel greataxe is used as a weapon";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting steel greataxe";
	}

	@Override
	public String getSimpleDescription() {
		return "craft steel greataxe";
	}
	...
	public ImageIds getImageIds(WorldObject performer) {
		return ImageIds.STEEL_GREATAXE;
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_GREATAXE_ANIMATION;
	}
