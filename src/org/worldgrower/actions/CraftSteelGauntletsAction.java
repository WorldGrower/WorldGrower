...
public class CraftSteelGauntletsAction implements CraftEquipmentAction, AnimatedAction {
	private static final int DISTANCE = 1;
	private static final int WOOD_REQUIRED = 5;
	private static final int STEEL_REQUIRED = 4;
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.STEEL_GAUNTLETS.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "steel gauntlets are used as armor to reduce the damage taken from attacks, and increase damage of unarmed attacks";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting steel gauntlets";
	}

	@Override
	public String getSimpleDescription() {
		return "craft steel gauntlets";
	}
	...
	public ImageIds getImageIds(WorldObject performer) {
		return ImageIds.STEEL_GAUNTLETS;
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_GAUNTLETS_ANIMATION;
	}
