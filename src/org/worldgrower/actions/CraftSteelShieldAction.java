...
public class CraftSteelShieldAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.STEEL_SHIELD.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "a steel shield is used as armor to reduce the damage taken from attacks";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting steel shield";
	}

	@Override
	public String getSimpleDescription() {
		return "craft steel shield";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_SHIELD_ANIMATION;
	}
