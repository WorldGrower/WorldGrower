...
public class CraftSteelClaymoreAction implements CraftEquipmentAction, AnimatedAction  {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.STEEL_CLAYMORE.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "a steel claymore is used as a weapon";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_CLAYMORE_ANIMATION;
	}
