...
public class WeaveCottonHatAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		Item.COTTON_HAT.addToInventory(performer, target, Constants.WEAVING_SKILL, Constants.WEAVERY_QUALITY, world);
	...
	public String getDescription() {
		return "a cotton hat is used as armor to reduce the damage taken from attacks";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.COTTON_HAT_ANIMATION;
	}
