...
public class WeaveCottonPantsAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		Item.COTTON_PANTS.addToInventory(performer, target, Constants.WEAVING_SKILL, Constants.WEAVERY_QUALITY, world);
	...
	public String getDescription() {
		return "cotton pants are used as armor to reduce the damage taken from attacks";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.COTTON_PANTS_ANIMATION;
	}
