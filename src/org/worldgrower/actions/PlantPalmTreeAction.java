...
public class PlantPalmTreeAction implements BuildAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		PlantGenerator.generatePalmTree(x, y, world, SkillUtils.useSkill(performer, Constants.LUMBERING_SKILL, world.getWorldStateChangedListeners()));
	}
	...
	public FormattableText getFormattableDescription() {
		return new FormattableText(TextId.PLANT_PALM_TREE, Item.WOOD);
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "planting a palm tree";
	}
	
	@Override
	public String getSimpleDescription() {
		return "plant palm tree";
	}
	...
	private BuildingDimensions getBuildingDimensions() {
		return BuildingDimensions.PALM_TREE;
	}
