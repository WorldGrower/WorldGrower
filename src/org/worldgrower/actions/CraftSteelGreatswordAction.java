...
public class CraftSteelGreatswordAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.STEEL_GREATSWORD.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "a steel greatsword is used as a weapon";
	}
	...
	public ImageIds getImageIds(WorldObject performer) {
		return ImageIds.STEEL_GREATSWORD;
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_GREATSWORD_ANIMATION;
	}
