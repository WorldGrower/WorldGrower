...
public class CraftShortBowAction implements CraftRangedWeaponAction, AnimatedAction {
	...
	public String getDescription() {
		return "a shortbow is used as a ranged weapon";
	}
	...
	public ImageIds getImageIds(WorldObject performer) {
		return ImageIds.SHORT_BOW;
	}

	@Override
	public ImageIds getAnimationImageId() {
		return ImageIds.SHORT_BOW_ANIMATION;
	}
