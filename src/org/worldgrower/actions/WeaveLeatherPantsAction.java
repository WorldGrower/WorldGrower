...
public class WeaveLeatherPantsAction implements CraftEquipmentAction, AnimatedAction {
	...
	public String getDescription() {
		return "leather pants are used as armor to reduce the damage taken from attacks";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.LEATHER_PANTS_ANIMATION;
	}
