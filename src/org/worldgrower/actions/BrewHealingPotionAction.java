...
public class BrewHealingPotionAction implements CraftAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.HEALING_POTION.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "Healing potion heals damage if ingested";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "brewing a healing potion";
	}
	...
	public FormattableText getFormattableSimpleDescription() {
		return new FormattableText(TextId.BREW_ITEM, Item.HEALING_POTION);
	}

	@Override
	public ImageIds getImageIds(WorldObject performer) {
		return ImageIds.HEALING_POTION;
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.HEALING_POTION_ANIMATION;
	}
