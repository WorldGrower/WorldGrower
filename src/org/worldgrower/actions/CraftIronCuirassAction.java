...
public class CraftIronCuirassAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.IRON_CUIRASS.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "an iron cuirass is used as armor to reduce the damage taken from attacks";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.IRON_CUIRASS_ANIMATION;
	}
