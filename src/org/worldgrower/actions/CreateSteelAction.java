...
public class CreateSteelAction implements CraftAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		SkillUtils.useSkill(performer, Constants.SMITHING_SKILL, world.getWorldStateChangedListeners());
		inventory.addQuantity(Item.STEEL.generate(1f), 1);
	...
	public String getDescription() {
		return "steel is used to create weapons and heavy armor";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_ANIMATION;
	}
