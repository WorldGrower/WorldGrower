...
public class CraftIronMaceAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.IRON_MACE.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "an iron mace is used as a weapon";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.IRON_MACE_ANIMATION;
	}
