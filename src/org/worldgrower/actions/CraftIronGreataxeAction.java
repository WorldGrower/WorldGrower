...
public class CraftIronGreataxeAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.IRON_GREATAXE.generate(skillBonus), quantity);
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting iron greataxe";
	}

	@Override
	public String getSimpleDescription() {
		return "craft iron greataxe";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.IRON_GREATAXE_ANIMATION;
	}
