...
public class ConstructKitchenAction implements CraftAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.KITCHEN.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "a residence with a kitchen allows cooking food";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "constructing a kitchen";
	}

	@Override
	public FormattableText getFormattableSimpleDescription() {
		return new FormattableText(TextId.CRAFT_ITEM, Item.KITCHEN);
	}
