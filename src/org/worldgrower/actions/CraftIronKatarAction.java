...
public class CraftIronKatarAction implements CraftEquipmentAction, AnimatedAction {
	...
	public void execute(WorldObject performer, WorldObject target, int[] args, World world) {
		...
		inventory.addQuantity(Item.IRON_KATAR.generate(skillBonus), quantity);
	...
	public String getDescription() {
		return "an iron katar is used as a weapon";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting iron katar";
	}

	@Override
	public String getSimpleDescription() {
		return "craft iron katar";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.IRON_KATAR_ANIMATION;
	}
