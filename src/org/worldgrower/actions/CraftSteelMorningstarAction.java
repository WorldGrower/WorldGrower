...
public class CraftSteelMorningstarAction implements CraftEquipmentAction, AnimatedAction {
	...
	public String getDescription() {
		return "a steel morningstar is used as a weapon";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting steel morningstar";
	}
	...
	public ImageIds getImageIds(WorldObject performer) {
		return ImageIds.STEEL_MORNINGSTAR;
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_MORNINGSTAR_ANIMATION;
	}
