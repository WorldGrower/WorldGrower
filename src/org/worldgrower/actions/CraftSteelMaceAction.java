...
public class CraftSteelMaceAction implements CraftEquipmentAction, AnimatedAction {
	...
	public String getDescription() {
		return "a steel mace is used as a weapon";
	}
	...
	public String getDescription(WorldObject performer, WorldObject target, int[] args, World world) {
		return "crafting steel mace";
	}

	@Override
	public String getSimpleDescription() {
		return "craft steel mace";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_MACE_ANIMATION;
	}
