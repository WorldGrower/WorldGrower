...
public class CraftSteelDaggerAction implements CraftEquipmentAction, AnimatedAction {
	private static final int DISTANCE = 1;
	private static final int WOOD_REQUIRED = 3;
	private static final int STEEL_REQUIRED = 2;
	...
	public String getDescription() {
		return "a steel dagger is used as a weapon";
	}
	...
	public ImageIds getAnimationImageId() {
		return ImageIds.STEEL_DAGGER_ANIMATION;
	}
