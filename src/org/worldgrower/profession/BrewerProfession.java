...
public class BrewerProfession implements Profession {

	public BrewerProfession(List<Profession> allProfessions) {
	...
	public List<Item> getSellItems() {
		return Arrays.asList(Item.WINE);
	}
