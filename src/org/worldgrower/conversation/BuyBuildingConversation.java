...
public class BuyBuildingConversation implements Conversation {
	...
	public List<Question> getQuestionPhrases(WorldObject performer, WorldObject target, HistoryItem questionHistoryItem, WorldObject subjectWorldObject, World world) {
		...
		return Arrays.asList(new Question(TextId.QUESTION_BUY_BUILDING, SentenceUtils.getArticle(description), description));
	}
	
	@Override
	public List<Response> getReplyPhrases(ConversationContext conversationContext) {
		return Arrays.asList(
			new Response(YES, TextId.ANSWER_BUY_BUILDING_YES),
			new Response(NO, TextId.ANSWER_BUY_BUILDING_NO)
			);
	}
