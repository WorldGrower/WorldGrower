...
public class SellBuildingConversation implements Conversation {
	...
	public Response getReplyPhrase(ConversationContext conversationContext) {
		...
		int buildingId = performer.getProperty(Constants.BUILDINGS).getFirstId(buildingType);
	...
	public List<Question> getQuestionPhrases(WorldObject performer, WorldObject target, HistoryItem questionHistoryItem, WorldObject subjectWorldObject, World world) {
		...
		return Arrays.asList(new Question(TextId.QUESTION_SELL_BUILDING, SentenceUtils.getArticle(description), description));
	}
	
	@Override
	public List<Response> getReplyPhrases(ConversationContext conversationContext) {
		return Arrays.asList(
			new Response(YES, TextId.ANSWER_SELL_BUILDING_YES),
			new Response(NO, TextId.ANSWER_SELL_BUILDING_NO)
			);
	}
