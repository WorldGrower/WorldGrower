...
public class GuiGetItemAction extends AbstractAction {
	...
	public GuiGetItemAction(WorldObject playerCharacter, World world, DungeonMaster dungeonMaster, JComponent container, WorldObject target, ImageInfoReader imageInfoReader) {
		super();
