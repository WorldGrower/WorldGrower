...
public class GuiBuyAction extends AbstractAction {
	...
	public GuiBuyAction(WorldObject playerCharacter, World world, DungeonMaster dungeonMaster, JComponent container, WorldObject target, ImageInfoReader imageInfoReader) {
		super();
