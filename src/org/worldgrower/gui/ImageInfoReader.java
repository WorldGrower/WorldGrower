...
public class ImageInfoReader implements SmallImageTagFactory {
    ...
    public ImageInfoReader() throws IOException {
		...
		createGhostImage(ImageIds.BLUE_HAIRED_COMMONER_GHOST, ImageIds.BLUE_HAIRED_COMMONER);
		createGhostImage(ImageIds.TULBAN_MALE_COMMONER_GHOST, ImageIds.TULBAN_MALE_COMMONER);
		createGhostImage(ImageIds.GREEN_HAIRED_COMMONER_GHOST, ImageIds.GREEN_HAIRED_COMMONER);
		createGhostImage(ImageIds.MALE_SCIENTIST_COMMONER_GHOST, ImageIds.MALE_SCIENTIST_COMMONER);
		createGhostImage(ImageIds.GREEN_HAIRED_MALE_BOY_GHOST, ImageIds.GREEN_HAIRED_MALE_BOY);
		createGhostImage(ImageIds.GREEN_HAIRED_MALE_COMMONER_GHOST, ImageIds.GREEN_HAIRED_MALE_COMMONER);
		createGhostImage(ImageIds.PURPLE_HAIRED_MALE_COMMONER_GHOST, ImageIds.PURPLE_HAIRED_MALE_COMMONER);
		createGhostImage(ImageIds.GREY_HAIRED_MALE_COMMONER_GHOST, ImageIds.GREY_HAIRED_MALE_COMMONER);
		createGhostImage(ImageIds.BLUE_HAT_MALE_COMMONER_GHOST, ImageIds.BLUE_HAT_MALE_COMMONER);
		createGhostImage(ImageIds.BOLD_MALE_COMMONER_GHOST, ImageIds.BOLD_MALE_COMMONER);
		createGhostImage(ImageIds.MALE_CHEF_COMMONER_GHOST, ImageIds.MALE_CHEF_COMMONER);
		createGhostImage(ImageIds.SPIKY_HAIR_MALE_COMMONER_GHOST, ImageIds.SPIKY_HAIR_MALE_COMMONER);
		createGhostImage(ImageIds.GREY_HAIR_MALE_COMMONER_GHOST, ImageIds.GREY_HAIR_MALE_COMMONER);
		createGhostImage(ImageIds.MALE_BAKER_COMMONER_GHOST, ImageIds.MALE_BAKER_COMMONER);
		createGhostImage(ImageIds.GREEN_HAIR_MALE_COMMONER_GHOST, ImageIds.GREEN_HAIR_MALE_COMMONER);
		createGhostImage(ImageIds.MALE_SAGE_COMMONER_GHOST, ImageIds.MALE_SAGE_COMMONER);
		createGhostImage(ImageIds.MALE_MERCHANT_COMMONER_GHOST, ImageIds.MALE_MERCHANT_COMMONER);
		createGhostImage(ImageIds.MALE_CAPTAIN_COMMONER_GHOST, ImageIds.MALE_CAPTAIN_COMMONER);
		createGhostImage(ImageIds.ORANGE_HAIR_BOY_COMMONER_GHOST, ImageIds.ORANGE_HAIR_BOY_COMMONER);
		createGhostImage(ImageIds.TULBAN_BOY_COMMONER_GHOST, ImageIds.TULBAN_BOY_COMMONER);
		createGhostImage(ImageIds.SKINHEAD_BOY_COMMONER_GHOST, ImageIds.SKINHEAD_BOY_COMMONER);
		createGhostImage(ImageIds.MALE_LEADER_GHOST, ImageIds.MALE_LEADER);
		createGhostImage(ImageIds.MALE_SENATOR_GHOST, ImageIds.MALE_SENATOR);
		createGhostImage(ImageIds.MALE_BELLBOY_GHOST, ImageIds.MALE_BELLBOY);
		createGhostImage(ImageIds.MALE_LAWYER_GHOST, ImageIds.MALE_LAWYER);
		createGhostImage(ImageIds.MALE_SAILOR_GHOST, ImageIds.MALE_SAILOR);
		createGhostImage(ImageIds.MALE_WHITE_SHIRT_SAILOR_GHOST, ImageIds.MALE_WHITE_SHIRT_SAILOR);
		createGhostImage(ImageIds.MALE_BLOND_SAILOR_GHOST, ImageIds.MALE_BLOND_SAILOR);
		createGhostImage(ImageIds.MALE_CAPTAIN_GHOST, ImageIds.MALE_CAPTAIN);
		createGhostImage(ImageIds.MALE_BALD_SAILOR_GHOST, ImageIds.MALE_BALD_SAILOR);
		createGhostImage(ImageIds.MALE_GREEN_BANDANA_SAILOR_GHOST, ImageIds.MALE_GREEN_BANDANA_SAILOR);
		createGhostImage(ImageIds.MALE_BALD_COMMONER_GHOST, ImageIds.MALE_BALD_COMMONER);
		createGhostImage(ImageIds.MALE_BEARDED_COMMONER_GHOST, ImageIds.MALE_BEARDED_COMMONER);
		createGhostImage(ImageIds.YOUNG_BOY_COMMONER_GHOST, ImageIds.YOUNG_BOY_COMMONER);
		createGhostImage(ImageIds.MALE_BLUE_PANTS_BOY_COMMONER_GHOST, ImageIds.MALE_BLUE_PANTS_BOY_COMMONER);
		createGhostImage(ImageIds.MALE_OLD_COMMONER_GHOST, ImageIds.MALE_OLD_COMMONER);
		createGhostImage(ImageIds.MALE_SPIKY_HAIRED_COMMONER_GHOST, ImageIds.MALE_SPIKY_HAIRED_COMMONER);
		createGhostImage(ImageIds.MALE_GREEN_HAIRED_COMMONER_GHOST, ImageIds.MALE_GREEN_HAIRED_COMMONER);
		createGhostImage(ImageIds.MALE_BROWN_HAIR_BOY_COMMONER_GHOST, ImageIds.MALE_BROWN_HAIR_BOY_COMMONER);
		createGhostImage(ImageIds.MALE_3C_1_GHOST, ImageIds.MALE_3C_1);
		createGhostImage(ImageIds.MALE_3C_2_GHOST, ImageIds.MALE_3C_2);
		createGhostImage(ImageIds.MALE_3C_3_GHOST, ImageIds.MALE_3C_3);
		createGhostImage(ImageIds.MALE_3C_4_GHOST, ImageIds.MALE_3C_4);
		createGhostImage(ImageIds.MALE_3D_1_GHOST, ImageIds.MALE_3D_1);
		createGhostImage(ImageIds.MALE_3D_2_GHOST, ImageIds.MALE_3D_2);
		createGhostImage(ImageIds.MALE_3D_3_GHOST, ImageIds.MALE_3D_3);
		createGhostImage(ImageIds.MALE_3E_1_GHOST, ImageIds.MALE_3E_1);
		createGhostImage(ImageIds.MALE_3E_2_GHOST, ImageIds.MALE_3E_2);
		createGhostImage(ImageIds.MALE_3E_3_GHOST, ImageIds.MALE_3E_3);
		createGhostImage(ImageIds.MALE_3E_4_GHOST, ImageIds.MALE_3E_4);
		createGhostImage(ImageIds.MALE_3F_1_GHOST, ImageIds.MALE_3F_1);
		createGhostImage(ImageIds.MALE_3F_2_GHOST, ImageIds.MALE_3F_2);
		createGhostImage(ImageIds.MALE_3F_3_GHOST, ImageIds.MALE_3F_3);
		createGhostImage(ImageIds.MALE_3F_4_GHOST, ImageIds.MALE_3F_4);
		createGhostImage(ImageIds.MALE_3G_1_GHOST, ImageIds.MALE_3G_1);
		createGhostImage(ImageIds.MALE_3G_2_GHOST, ImageIds.MALE_3G_2);
		createGhostImage(ImageIds.MALE_3G_3_GHOST, ImageIds.MALE_3G_3);
		createGhostImage(ImageIds.MALE_3G_4_GHOST, ImageIds.MALE_3G_4);
		createGhostImage(ImageIds.MALE_01_1_GHOST, ImageIds.MALE_01_1);
		createGhostImage(ImageIds.MALE_01_2_GHOST, ImageIds.MALE_01_2);
		createGhostImage(ImageIds.MALE_01_3_GHOST, ImageIds.MALE_01_3);
		createGhostImage(ImageIds.MALE_01_4_GHOST, ImageIds.MALE_01_4);
		createGhostImage(ImageIds.MALE_AKTOR1_1_GHOST, ImageIds.MALE_AKTOR1_1);
		createGhostImage(ImageIds.MALE_AKTOR1_2_GHOST, ImageIds.MALE_AKTOR1_2);
		createGhostImage(ImageIds.MALE_AKTOR1_3_GHOST, ImageIds.MALE_AKTOR1_3);
		createGhostImage(ImageIds.MALE_AKTOR1_4_GHOST, ImageIds.MALE_AKTOR1_4);
		createGhostImage(ImageIds.MALE_AKTOR3_1_GHOST, ImageIds.MALE_AKTOR3_1);
		createGhostImage(ImageIds.MALE_AKTOR3_2_GHOST, ImageIds.MALE_AKTOR3_2);
		createGhostImage(ImageIds.MALE_AKTOR3_3_GHOST, ImageIds.MALE_AKTOR3_3);
		createGhostImage(ImageIds.MALE_AKTOR3_4_GHOST, ImageIds.MALE_AKTOR3_4);
		createGhostImage(ImageIds.MALE_HERO_GHOST, ImageIds.MALE_HERO);
		createGhostImage(ImageIds.SAM_NPC_GHOST, ImageIds.SAM_NPC);
		createGhostImage(ImageIds.NICOLAI_NPC_GHOST, ImageIds.NICOLAI_NPC);
		createGhostImage(ImageIds.MALE_PIRATE_GHOST, ImageIds.MALE_PIRATE);
		createGhostImage(ImageIds.MALE_PIRATE52_GHOST, ImageIds.MALE_PIRATE52);
		createGhostImage(ImageIds.MALE_PIRATE02_GHOST, ImageIds.MALE_PIRATE02);
		createGhostImage(ImageIds.MALE_PIRATE03_GHOST, ImageIds.MALE_PIRATE03);
		createGhostImage(ImageIds.MALE_STEAMPUNK_GHOST, ImageIds.MALE_STEAMPUNK);
		createGhostImage(ImageIds.MALE_MASKED_AUSTRIA_GHOST, ImageIds.MALE_MASKED_AUSTRIA);
		createGhostImage(ImageIds.MALE_YOUNG_AMERICA_GHOST, ImageIds.MALE_YOUNG_AMERICA);
		createGhostImage(ImageIds.MALE_YOUNG_CANADA_GHOST, ImageIds.MALE_YOUNG_CANADA);
		createGhostImage(ImageIds.MALE_WEISS_GHOST, ImageIds.MALE_WEISS);
		createGhostImage(ImageIds.MALE_CHAR_A1_GHOST, ImageIds.MALE_CHAR_A1);
		createGhostImage(ImageIds.MALE_CHAR_A2_GHOST, ImageIds.MALE_CHAR_A2);
		createGhostImage(ImageIds.MALE_CHAR_A3_GHOST, ImageIds.MALE_CHAR_A3);
		createGhostImage(ImageIds.MALE_CHAR_A4_GHOST, ImageIds.MALE_CHAR_A4);
		createGhostImage(ImageIds.MALE_CHAR_A5_GHOST, ImageIds.MALE_CHAR_A5);
		createGhostImage(ImageIds.MALE_CHAR_A6_GHOST, ImageIds.MALE_CHAR_A6);
