...
public class ImageInfoReader implements SmallImageTagFactory {
    ...
    public ImageInfoReader(GhostImageIds ghostImageIds) throws IOException {
		...
		createGhostImage(ImageIds.KNIGHT_GHOST, ImageIds.KNIGHT, ghostImageIds);
		createGhostImage(ImageIds.GUARD_GHOST, ImageIds.GUARD, ghostImageIds);
		createGhostImage(ImageIds.BLUE_HAIRED_COMMONER_GHOST, ImageIds.BLUE_HAIRED_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.TULBAN_MALE_COMMONER_GHOST, ImageIds.TULBAN_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.GREEN_HAIRED_COMMONER_GHOST, ImageIds.GREEN_HAIRED_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_SCIENTIST_COMMONER_GHOST, ImageIds.MALE_SCIENTIST_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.GREEN_HAIRED_MALE_BOY_GHOST, ImageIds.GREEN_HAIRED_MALE_BOY, ghostImageIds);
		createGhostImage(ImageIds.GREEN_HAIRED_MALE_COMMONER_GHOST, ImageIds.GREEN_HAIRED_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.PURPLE_HAIRED_MALE_COMMONER_GHOST, ImageIds.PURPLE_HAIRED_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.GREY_HAIRED_MALE_COMMONER_GHOST, ImageIds.GREY_HAIRED_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.BLUE_HAT_MALE_COMMONER_GHOST, ImageIds.BLUE_HAT_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.BOLD_MALE_COMMONER_GHOST, ImageIds.BOLD_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_CHEF_COMMONER_GHOST, ImageIds.MALE_CHEF_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.SPIKY_HAIR_MALE_COMMONER_GHOST, ImageIds.SPIKY_HAIR_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.GREY_HAIR_MALE_COMMONER_GHOST, ImageIds.GREY_HAIR_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_BAKER_COMMONER_GHOST, ImageIds.MALE_BAKER_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.GREEN_HAIR_MALE_COMMONER_GHOST, ImageIds.GREEN_HAIR_MALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_SAGE_COMMONER_GHOST, ImageIds.MALE_SAGE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_MERCHANT_COMMONER_GHOST, ImageIds.MALE_MERCHANT_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_CAPTAIN_COMMONER_GHOST, ImageIds.MALE_CAPTAIN_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.ORANGE_HAIR_BOY_COMMONER_GHOST, ImageIds.ORANGE_HAIR_BOY_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.TULBAN_BOY_COMMONER_GHOST, ImageIds.TULBAN_BOY_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.SKINHEAD_BOY_COMMONER_GHOST, ImageIds.SKINHEAD_BOY_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_LEADER_GHOST, ImageIds.MALE_LEADER, ghostImageIds);
		createGhostImage(ImageIds.MALE_SENATOR_GHOST, ImageIds.MALE_SENATOR, ghostImageIds);
		createGhostImage(ImageIds.MALE_BELLBOY_GHOST, ImageIds.MALE_BELLBOY, ghostImageIds);
		createGhostImage(ImageIds.MALE_LAWYER_GHOST, ImageIds.MALE_LAWYER, ghostImageIds);
		createGhostImage(ImageIds.MALE_SAILOR_GHOST, ImageIds.MALE_SAILOR, ghostImageIds);
		createGhostImage(ImageIds.MALE_WHITE_SHIRT_SAILOR_GHOST, ImageIds.MALE_WHITE_SHIRT_SAILOR, ghostImageIds);
		createGhostImage(ImageIds.MALE_BLOND_SAILOR_GHOST, ImageIds.MALE_BLOND_SAILOR, ghostImageIds);
		createGhostImage(ImageIds.MALE_CAPTAIN_GHOST, ImageIds.MALE_CAPTAIN, ghostImageIds);
		createGhostImage(ImageIds.MALE_BALD_SAILOR_GHOST, ImageIds.MALE_BALD_SAILOR, ghostImageIds);
		createGhostImage(ImageIds.MALE_GREEN_BANDANA_SAILOR_GHOST, ImageIds.MALE_GREEN_BANDANA_SAILOR, ghostImageIds);
		createGhostImage(ImageIds.MALE_BALD_COMMONER_GHOST, ImageIds.MALE_BALD_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_BEARDED_COMMONER_GHOST, ImageIds.MALE_BEARDED_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.YOUNG_BOY_COMMONER_GHOST, ImageIds.YOUNG_BOY_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_BLUE_PANTS_BOY_COMMONER_GHOST, ImageIds.MALE_BLUE_PANTS_BOY_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_OLD_COMMONER_GHOST, ImageIds.MALE_OLD_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_SPIKY_HAIRED_COMMONER_GHOST, ImageIds.MALE_SPIKY_HAIRED_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_GREEN_HAIRED_COMMONER_GHOST, ImageIds.MALE_GREEN_HAIRED_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_BROWN_HAIR_BOY_COMMONER_GHOST, ImageIds.MALE_BROWN_HAIR_BOY_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.MALE_3C_1_GHOST, ImageIds.MALE_3C_1, ghostImageIds);
		createGhostImage(ImageIds.MALE_3C_2_GHOST, ImageIds.MALE_3C_2, ghostImageIds);
		createGhostImage(ImageIds.MALE_3C_3_GHOST, ImageIds.MALE_3C_3, ghostImageIds);
		createGhostImage(ImageIds.MALE_3C_4_GHOST, ImageIds.MALE_3C_4, ghostImageIds);
		createGhostImage(ImageIds.MALE_3D_1_GHOST, ImageIds.MALE_3D_1, ghostImageIds);
		createGhostImage(ImageIds.MALE_3D_2_GHOST, ImageIds.MALE_3D_2, ghostImageIds);
		createGhostImage(ImageIds.MALE_3D_3_GHOST, ImageIds.MALE_3D_3, ghostImageIds);
		createGhostImage(ImageIds.MALE_3E_1_GHOST, ImageIds.MALE_3E_1, ghostImageIds);
		createGhostImage(ImageIds.MALE_3E_2_GHOST, ImageIds.MALE_3E_2, ghostImageIds);
		createGhostImage(ImageIds.MALE_3E_3_GHOST, ImageIds.MALE_3E_3, ghostImageIds);
		createGhostImage(ImageIds.MALE_3E_4_GHOST, ImageIds.MALE_3E_4, ghostImageIds);
		createGhostImage(ImageIds.MALE_3F_1_GHOST, ImageIds.MALE_3F_1, ghostImageIds);
		createGhostImage(ImageIds.MALE_3F_2_GHOST, ImageIds.MALE_3F_2, ghostImageIds);
		createGhostImage(ImageIds.MALE_3F_3_GHOST, ImageIds.MALE_3F_3, ghostImageIds);
		createGhostImage(ImageIds.MALE_3F_4_GHOST, ImageIds.MALE_3F_4, ghostImageIds);
		createGhostImage(ImageIds.MALE_3G_1_GHOST, ImageIds.MALE_3G_1, ghostImageIds);
		createGhostImage(ImageIds.MALE_3G_2_GHOST, ImageIds.MALE_3G_2, ghostImageIds);
		createGhostImage(ImageIds.MALE_3G_3_GHOST, ImageIds.MALE_3G_3, ghostImageIds);
		createGhostImage(ImageIds.MALE_3G_4_GHOST, ImageIds.MALE_3G_4, ghostImageIds);
		createGhostImage(ImageIds.MALE_01_1_GHOST, ImageIds.MALE_01_1, ghostImageIds);
		createGhostImage(ImageIds.MALE_01_2_GHOST, ImageIds.MALE_01_2, ghostImageIds);
		createGhostImage(ImageIds.MALE_01_3_GHOST, ImageIds.MALE_01_3, ghostImageIds);
		createGhostImage(ImageIds.MALE_01_4_GHOST, ImageIds.MALE_01_4, ghostImageIds);
		createGhostImage(ImageIds.MALE_AKTOR1_1_GHOST, ImageIds.MALE_AKTOR1_1, ghostImageIds);
		createGhostImage(ImageIds.MALE_AKTOR1_2_GHOST, ImageIds.MALE_AKTOR1_2, ghostImageIds);
		createGhostImage(ImageIds.MALE_AKTOR1_3_GHOST, ImageIds.MALE_AKTOR1_3, ghostImageIds);
		createGhostImage(ImageIds.MALE_AKTOR1_4_GHOST, ImageIds.MALE_AKTOR1_4, ghostImageIds);
		createGhostImage(ImageIds.MALE_AKTOR3_1_GHOST, ImageIds.MALE_AKTOR3_1, ghostImageIds);
		createGhostImage(ImageIds.MALE_AKTOR3_2_GHOST, ImageIds.MALE_AKTOR3_2, ghostImageIds);
		createGhostImage(ImageIds.MALE_AKTOR3_3_GHOST, ImageIds.MALE_AKTOR3_3, ghostImageIds);
		createGhostImage(ImageIds.MALE_AKTOR3_4_GHOST, ImageIds.MALE_AKTOR3_4, ghostImageIds);
		createGhostImage(ImageIds.MALE_HERO_GHOST, ImageIds.MALE_HERO, ghostImageIds);
		createGhostImage(ImageIds.SAM_NPC_GHOST, ImageIds.SAM_NPC, ghostImageIds);
		createGhostImage(ImageIds.NICOLAI_NPC_GHOST, ImageIds.NICOLAI_NPC, ghostImageIds);
		createGhostImage(ImageIds.MALE_PIRATE_GHOST, ImageIds.MALE_PIRATE, ghostImageIds);
		createGhostImage(ImageIds.MALE_PIRATE52_GHOST, ImageIds.MALE_PIRATE52, ghostImageIds);
		createGhostImage(ImageIds.MALE_PIRATE02_GHOST, ImageIds.MALE_PIRATE02, ghostImageIds);
		createGhostImage(ImageIds.MALE_PIRATE03_GHOST, ImageIds.MALE_PIRATE03, ghostImageIds);
		createGhostImage(ImageIds.MALE_STEAMPUNK_GHOST, ImageIds.MALE_STEAMPUNK, ghostImageIds);
		createGhostImage(ImageIds.MALE_MASKED_AUSTRIA_GHOST, ImageIds.MALE_MASKED_AUSTRIA, ghostImageIds);
		createGhostImage(ImageIds.MALE_YOUNG_AMERICA_GHOST, ImageIds.MALE_YOUNG_AMERICA, ghostImageIds);
		createGhostImage(ImageIds.MALE_YOUNG_CANADA_GHOST, ImageIds.MALE_YOUNG_CANADA, ghostImageIds);
		createGhostImage(ImageIds.MALE_WEISS_GHOST, ImageIds.MALE_WEISS, ghostImageIds);
		createGhostImage(ImageIds.MALE_CHAR_A1_GHOST, ImageIds.MALE_CHAR_A1, ghostImageIds);
		createGhostImage(ImageIds.MALE_CHAR_A2_GHOST, ImageIds.MALE_CHAR_A2, ghostImageIds);
		createGhostImage(ImageIds.MALE_CHAR_A3_GHOST, ImageIds.MALE_CHAR_A3, ghostImageIds);
		createGhostImage(ImageIds.MALE_CHAR_A4_GHOST, ImageIds.MALE_CHAR_A4, ghostImageIds);
		createGhostImage(ImageIds.MALE_CHAR_A5_GHOST, ImageIds.MALE_CHAR_A5, ghostImageIds);
		createGhostImage(ImageIds.MALE_CHAR_A6_GHOST, ImageIds.MALE_CHAR_A6, ghostImageIds);
		createGhostImage(ImageIds.MALE_MAX_CHAR_GHOST, ImageIds.MALE_MAX_CHAR, ghostImageIds);
		
		createGhostImage(ImageIds.FEMALE_COMMONER_GHOST, ImageIds.FEMALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.BLACK_HAIRED_FEMALE_COMMONER_GHOST, ImageIds.BLACK_HAIRED_FEMALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.PURPLE_HAIRED_MALE_GIRL_GHOST, ImageIds.PURPLE_HAIRED_MALE_GIRL, ghostImageIds);
		createGhostImage(ImageIds.PURPLE_HAT_COMMONER_GHOST, ImageIds.PURPLE_HAT_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.PINK_HAT_FEMALE_COMMONER_GHOST, ImageIds.PINK_HAT_FEMALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.RED_HAIR_FEMALE_COMMONER_GHOST, ImageIds.RED_HAIR_FEMALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_NUN_COMMONER_GHOST, ImageIds.FEMALE_NUN_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.BLUE_DRESS_FEMALE_COMMONER_GHOST, ImageIds.BLUE_DRESS_FEMALE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_BRIDE_COMMONER_GHOST, ImageIds.FEMALE_BRIDE_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_SENATOR_GHOST, ImageIds.FEMALE_SENATOR, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_RED_EYE_GHOST, ImageIds.FEMALE_RED_EYE, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_BUNNY_GHOST, ImageIds.FEMALE_BUNNY, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_MAID_GHOST, ImageIds.FEMALE_MAID, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_RED_HAIRED_SAILOR_GHOST, ImageIds.FEMALE_RED_HAIRED_SAILOR, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_SAILOR_GHOST, ImageIds.FEMALE_SAILOR, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_OLD_COMMONER_GHOST, ImageIds.FEMALE_OLD_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_BLOND_COMMONER_GHOST, ImageIds.FEMALE_BLOND_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_ORANGE_GIRL_GHOST, ImageIds.FEMALE_ORANGE_GIRL, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_ORANGE_HAIR_GIRL_COMMONER_GHOST, ImageIds.FEMALE_ORANGE_HAIR_GIRL_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_OLDER_COMMONER_GHOST, ImageIds.FEMALE_OLDER_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_MILKER_COMMONER_GHOST, ImageIds.FEMALE_MILKER_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_BLOND_GIRL_GHOST, ImageIds.FEMALE_BLOND_GIRL, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_BLUE_HAIR_GIRL_COMMONER_GHOST, ImageIds.FEMALE_BLUE_HAIR_GIRL_COMMONER, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3C_1_GHOST, ImageIds.FEMALE_3C_1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3C_2_GHOST, ImageIds.FEMALE_3C_2, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3C_3_GHOST, ImageIds.FEMALE_3C_3, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3C_4_GHOST, ImageIds.FEMALE_3C_4, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3D_1_GHOST, ImageIds.FEMALE_3D_1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3D_2_GHOST, ImageIds.FEMALE_3D_2, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3D_3_GHOST, ImageIds.FEMALE_3D_3, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3E_1_GHOST, ImageIds.FEMALE_3E_1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3E_2_GHOST, ImageIds.FEMALE_3E_2, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3E_3_GHOST, ImageIds.FEMALE_3E_3, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3E_4_GHOST, ImageIds.FEMALE_3E_4, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3F_1_GHOST, ImageIds.FEMALE_3F_1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3F_2_GHOST, ImageIds.FEMALE_3F_2, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3F_3_GHOST, ImageIds.FEMALE_3F_3, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3F_4_GHOST, ImageIds.FEMALE_3F_4, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3G_1_GHOST, ImageIds.FEMALE_3G_1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3G_2_GHOST, ImageIds.FEMALE_3G_2, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3G_3_GHOST, ImageIds.FEMALE_3G_3, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_3G_4_GHOST, ImageIds.FEMALE_3G_4, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_01_1_GHOST, ImageIds.FEMALE_01_1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_01_2_GHOST, ImageIds.FEMALE_01_2, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_01_3_GHOST, ImageIds.FEMALE_01_3, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_01_4_GHOST, ImageIds.FEMALE_01_4, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_AKTOR1_1_GHOST, ImageIds.FEMALE_AKTOR1_1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_AKTOR1_2_GHOST, ImageIds.FEMALE_AKTOR1_2, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_AKTOR1_3_GHOST, ImageIds.FEMALE_AKTOR1_3, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_AKTOR1_4_GHOST, ImageIds.FEMALE_AKTOR1_4, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_AKTOR3_1_GHOST, ImageIds.FEMALE_AKTOR3_1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_AKTOR3_2_GHOST, ImageIds.FEMALE_AKTOR3_2, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_AKTOR3_3_GHOST, ImageIds.FEMALE_AKTOR3_3, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_AKTOR3_4_GHOST, ImageIds.FEMALE_AKTOR3_4, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_HERO_GHOST, ImageIds.FEMALE_HERO, ghostImageIds);
		createGhostImage(ImageIds.SOPHIE_NPC_GHOST, ImageIds.SOPHIE_NPC, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_PIRATE_GHOST, ImageIds.FEMALE_PIRATE, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_PIRATE52_GHOST, ImageIds.FEMALE_PIRATE52, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_PIRATE02_GHOST, ImageIds.FEMALE_PIRATE02, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_PIRATE03_GHOST, ImageIds.FEMALE_PIRATE03, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_ITALY_GHOST, ImageIds.FEMALE_ITALY, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_FRANCE_GHOST, ImageIds.FEMALE_FRANCE, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_VELIA_GHOST, ImageIds.FEMALE_VELIA, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_CHAR_A1_GHOST, ImageIds.FEMALE_CHAR_A1, ghostImageIds);
		createGhostImage(ImageIds.FEMALE_ELLIE_CHAR_GHOST, ImageIds.FEMALE_ELLIE_CHAR, ghostImageIds);
		...
		add(ImageIds.KITCHEN_ICON, ImageUtils.cropImage(kitchen.bufferedImage, 48, 48));
    ...
    private void createGhostImage(ImageIds newImageId, ImageIds imageId, GhostImageIds ghostImageIds) {
		...
		ghostImageIds.addGhostImageId(imageId, newImageId);
	}
