...
public class GuiViewCandidatesAction extends AbstractAction {
	...
	public GuiViewCandidatesAction(WorldObject playerCharacter, ImageInfoReader imageInfoReader, SoundIdReader soundIdReader, World world, WorldPanel parent, DungeonMaster dungeonMaster, WorldObject worldObject, JFrame parentFrame) {
		super();
