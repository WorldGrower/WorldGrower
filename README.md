...
*   [Windows installer](https://github.com/WorldGrower/WorldGrower/releases/download/0.6.0/WorldGrower_windows-x64_0_6_0.exe)
*   [Linux installer](https://github.com/WorldGrower/WorldGrower/releases/download/0.6.0/WorldGrower_unix_0_6_0_64bit.sh) (requires java 8)
*   [MacOSX installer](https://github.com/WorldGrower/WorldGrower/releases/download/0.6.0/WorldGrower_macos_0_6_0.dmg)

*These installers contain the game and will install the game when executed.*

###Binary installation of .zip file

*   [Download .zip file](https://github.com/WorldGrower/WorldGrower/releases/download/0.6.0/worldgrower-0.6.0.zip)
