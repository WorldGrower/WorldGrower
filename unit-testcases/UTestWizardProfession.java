...
public class UTestWizardProfession {

	WizardProfession profession;
	List<Profession> professions;
	
	@Before
	public void setUp() {
		professions = new ArrayList<Profession>();
		profession = new WizardProfession(professions);
	}
	
	@Test
	public void testGetDescription() {
		assertEquals(profession.getDescription(), "wizard");
	}
	...
	public void testGetProfessionGoals() {
		...
		assertEquals(goals.get(1), Goals.SCRIBE_WIZARD_SPELLS_GOAL);
	}

	@Test
	public void testGetSkillProperty() {
		assertEquals(profession.getSkillProperty(), Constants.EVOCATION_SKILL);
	}

	//@Test
	//public void testReadResolve() throws ObjectStreamException {
	//	WizardProfession profession2 = new WizardProfession(professions);
