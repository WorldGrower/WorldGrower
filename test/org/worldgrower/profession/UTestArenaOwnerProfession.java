...
public class UTestArenaOwnerProfession  {

	ArenaOwnerProfession profession;
	List<Profession> professions;
	
	@Before
	public void setUp() {
		professions = new ArrayList<Profession>();
		profession = new ArenaOwnerProfession(professions);
	}
	
	@Test
	public void testGetDescription() {
		assertEquals(profession.getDescription(), "arena owner");
	}

	@Test
	public void testGetProfessionGoals() {
		List<Goal> goals = profession.getProfessionGoals();
		assertEquals(goals.get(0), Goals.ARENA_GOAL);
	}
	...
	//	ArenaOwnerProfession profession2 = new ArenaOwnerProfession(professions);
