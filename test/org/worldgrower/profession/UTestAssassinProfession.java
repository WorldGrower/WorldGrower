...
public class UTestAssassinProfession {

	AssassinProfession profession;
	List<Profession> professions;
	
	@Before
	public void setUp() {
		professions = new ArrayList<Profession>();
		profession = new AssassinProfession(professions);
	}
	
	@Test
	public void testGetDescription() {
		assertEquals(profession.getDescription(), "assassin");
	}
	...
	public void testGetProfessionGoals() {
		...
		assertEquals(goals.get(1), Goals.FIND_ASSASSINATION_CLIENT_GOAL);
	}

	@Test
	public void testGetSkillProperty() {
		assertEquals(profession.getSkillProperty(), Constants.ONE_HANDED_SKILL);
	}

	//@Test
	//public void testReadResolve() throws ObjectStreamException {
	//	AssassinProfession profession2 = new AssassinProfession(professions);
