...
public class DefaultConversationFormatter {
	public static final ConversationFormatter FORMATTER = new ConversationFormatterImpl(new TextConversationArgumentFormatter());
}
