...
public class UTestPlantNightShadeAction {
	...
	public void testExecute() {
		...
		Actions.PLANT_NIGHT_SHADE_ACTION.execute(performer, target, new int[0], world);
	...
	public void testDistance() {
		...
		assertEquals(0, Actions.PLANT_NIGHT_SHADE_ACTION.distance(performer, target, new int[0], world));
	}
