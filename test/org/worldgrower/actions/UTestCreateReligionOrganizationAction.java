...
public class UTestCreateReligionOrganizationAction {
	...
	public void testIsValidTarget() {
		...
		assertEquals(true, Actions.CREATE_RELIGION_ORGANIZATION_ACTION.isValidTarget(performer, performer, world));
		assertEquals(false, Actions.CREATE_RELIGION_ORGANIZATION_ACTION.isValidTarget(performer, target, world));
	}
