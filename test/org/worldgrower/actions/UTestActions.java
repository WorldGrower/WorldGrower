...
public class UTestActions {
	...
	public void testGetActionsWithTargetPropertyApothecary() {
		...
		assertEquals(Arrays.asList(Actions.BREW_POISON_ACTION, Actions.BREW_SLEEPING_POTION_ACTION, Actions.BREW_HEALING_POTION_ACTION, Actions.BREW_CURE_POISON_POTION_ACTION), actions);
	}
