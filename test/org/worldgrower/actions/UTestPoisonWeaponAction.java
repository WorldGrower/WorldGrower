...
public class UTestPoisonWeaponAction {
	...
	public void testExecute() {
		...
		Actions.POISON_WEAPON_ACTION.execute(performer, performer, new int[] {0}, world);
		
		assertEquals(1, performerInventory.getQuantityFor(Constants.POISON_DAMAGE));
		assertEquals(true, performerInventory.get(0).hasProperty(Constants.POISON_DAMAGE));
	}
	...
	public void testIsValidTarget() {
		...
		assertEquals(true, Actions.POISON_WEAPON_ACTION.isValidTarget(performer, performer, world));
		assertEquals(false, Actions.POISON_WEAPON_ACTION.isValidTarget(performer, target, world));
	}
