...
public class UTestBrewHealingPotionAction {

	private BrewHealingPotionAction action = Actions.BREW_HEALING_POTION_ACTION;
	...
	public void testExecute() {
		...
		assertEquals(1, performerInventory.getQuantityFor(Constants.HIT_POINTS_HEALED));
	}
