...
public class UTestRecallSecretChestAction {
	...
	public void testExecute() {
		...
		performer.getProperty(Constants.INVENTORY).add(Item.generateMiniatureChest(chest));
		
		assertEquals(-10, chest.getProperty(Constants.X).intValue());
		assertEquals(-10, chest.getProperty(Constants.Y).intValue());
		
		Actions.RECALL_SECRET_CHEST_ACTION.execute(performer, performer, new int[] {0}, world);
