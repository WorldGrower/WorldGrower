...
public class UTestCraftIronGauntletsAction {

	@Test
	public void testExecute() {
		World world = new WorldImpl(1, 1, null, null);
		WorldObject performer = TestUtils.createSkilledWorldObject(2, Constants.INVENTORY, new WorldObjectContainer());
		Actions.CRAFT_IRON_GAUNTLETS_ACTION.execute(performer, performer, Args.EMPTY, world);
	...
	public void testIsValidTarget() {
		...
		assertEquals(false, Actions.CRAFT_IRON_GAUNTLETS_ACTION.isValidTarget(performer, performer, world));
	...
	public void testIsActionPossible() {
		...
		assertEquals(true, Actions.CRAFT_IRON_GAUNTLETS_ACTION.isActionPossible(performer, target, Args.EMPTY, world));
	}
	...
	public void testDistance() {
		...
		assertEquals(0, Actions.CRAFT_IRON_GAUNTLETS_ACTION.distance(performer, target, Args.EMPTY, world));
	}
