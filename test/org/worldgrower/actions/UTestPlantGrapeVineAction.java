...
public class UTestPlantGrapeVineAction {
	...
	public void testExecute() {
		...
		Actions.PLANT_GRAPE_VINE_ACTION.execute(performer, target, Args.EMPTY, world);
	...
	public void testDistance() {
		...
		assertEquals(0, Actions.PLANT_GRAPE_VINE_ACTION.distance(performer, target, Args.EMPTY, world));
	}
