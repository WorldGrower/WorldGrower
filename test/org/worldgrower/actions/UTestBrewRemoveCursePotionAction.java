...
public class UTestBrewRemoveCursePotionAction {

	private BrewRemoveCursePotionAction action = Actions.BREW_REMOVE_CURSE_POTION_ACTION;
	...
	public void testExecute() {
		...
		assertEquals(5, performerInventory.getQuantityFor(Constants.NIGHT_SHADE));
		assertEquals(1, performerInventory.getQuantityFor(Constants.REMOVE_CURSE));
	}
