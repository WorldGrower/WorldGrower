...
public class UTestCraftIronShieldAction {
	...
	public void testExecute() {
		...
		Actions.CRAFT_IRON_SHIELD_ACTION.execute(performer, target, Args.EMPTY, world);
	...
	public void testIsValidTarget() {
		...
		assertEquals(true, Actions.CRAFT_IRON_SHIELD_ACTION.isValidTarget(performer, target, world));
	}
	...
	public void testIsActionPossible() {
		...
		assertEquals(true, Actions.CRAFT_IRON_SHIELD_ACTION.isActionPossible(performer, target, Args.EMPTY, world));
	}
