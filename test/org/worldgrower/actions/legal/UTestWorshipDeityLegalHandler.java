...
public class UTestWorshipDeityLegalHandler {

	private WorshipDeityLegalHandler legalHandler = new WorshipDeityLegalHandler(Deity.HADES);
	...
	public void testIsApplicable() {
		...
		performer.setProperty(Constants.DEITY, Deity.APOLLO);
		assertEquals(false, legalHandler.isApplicable(performer, target, Args.EMPTY));
