...
public class UTestCreateSteelAction {

	private CreateSteelAction action = Actions.CREATE_STEEL_ACTION;
	...
	public void testExecute() {
		...
		assertEquals(1, performer.getProperty(Constants.INVENTORY).getQuantityFor(Constants.STEEL));
	}
