...
public class UTestBuildJailAction {
	...
	public void testExecute() {
		...
		Actions.BUILD_JAIL_ACTION.execute(performer, target, Args.EMPTY, world);
		
		assertEquals(4, world.getWorldObjects().size());
		assertEquals("Jail left", world.getWorldObjects().get(0).getProperty(Constants.NAME));
	}
	...
	public void testIsActionPossible() {
		...
		assertEquals(true, Actions.BUILD_JAIL_ACTION.isActionPossible(performer, target, Args.EMPTY, world));
	}
