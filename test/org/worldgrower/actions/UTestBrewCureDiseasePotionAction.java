...
public class UTestBrewCureDiseasePotionAction {

	private BrewCureDiseasePotionAction action = Actions.BREW_CURE_DISEASE_POTION_ACTION;
	...
	public void testExecute() {
		...
		assertEquals(1, performerInventory.getQuantityFor(Constants.CURE_DISEASE));
	}
