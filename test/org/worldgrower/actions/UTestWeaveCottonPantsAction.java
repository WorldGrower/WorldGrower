...
public class UTestWeaveCottonPantsAction {

	@Test
	public void testExecute() {
		World world = new WorldImpl(1, 1, null, null);
		WorldObject performer = TestUtils.createSkilledWorldObject(2, Constants.INVENTORY, new WorldObjectContainer());
		Actions.WEAVE_COTTON_PANTS_ACTION.execute(performer, performer, Args.EMPTY, world);
	...
	public void testIsValidTarget() {
		...
		assertEquals(false, Actions.WEAVE_COTTON_PANTS_ACTION.isValidTarget(performer, performer, world));
		assertEquals(true, Actions.WEAVE_COTTON_PANTS_ACTION.isValidTarget(performer, target, world));
	}
