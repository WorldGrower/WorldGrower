...
public class UTestBuildBreweryAction {
	...
	public void testExecute() {
		...
		Actions.BUILD_BREWERY_ACTION.execute(performer, target, Args.EMPTY, world);
		
		assertEquals(1, world.getWorldObjects().size());
		assertEquals(BuildingType.BREWERY, world.getWorldObjects().get(0).getProperty(Constants.BUILDING_TYPE));
	}
	...
	public void testIsActionPossible() {
		...
		assertEquals(true, Actions.BUILD_BREWERY_ACTION.isActionPossible(performer, target, Args.EMPTY, world));
	}
	...
	public void testDistance() {
		...
		assertEquals(0, Actions.BUILD_BREWERY_ACTION.distance(performer, target, Args.EMPTY, world));
	}
