...
public class UTestConstructLampAction {

	private ConstructLampAction action = Actions.CONSTRUCT_LAMP_ACTION;
	...
	public void testExecute() {
		...
		assertEquals(1, performer.getProperty(Constants.INVENTORY).getQuantityFor(Constants.LIGHT_SOURCE));
	}
	...
	public void testIsActionPossible() {
		...
		WorldObject workbench = createWorkbench(world, performer);
		assertEquals(false, action.isActionPossible(performer, workbench, Args.EMPTY, world));
		
		performer.getProperty(Constants.INVENTORY).addQuantity(Item.OIL.generate(1f), 20);
