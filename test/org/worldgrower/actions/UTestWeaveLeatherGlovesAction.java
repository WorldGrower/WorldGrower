...
public class UTestWeaveLeatherGlovesAction {

	private final WeaveLeatherGlovesAction action = Actions.WEAVE_LEATHER_GLOVES_ACTION;
	...
	public void testIsActionPossible() {
		World world = new WorldImpl(10, 10, null, null);
		WorldObject performer = TestUtils.createSkilledWorldObject(2, Constants.INVENTORY, new WorldObjectContainer());
		performer.getProperty(Constants.INVENTORY).addQuantity(Item.LEATHER.generate(1f), 20);
