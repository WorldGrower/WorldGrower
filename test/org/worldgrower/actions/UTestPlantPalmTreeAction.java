...
public class UTestPlantPalmTreeAction {
	...
	public void testExecute() {
		...
		Actions.PLANT_PALM_TREE_ACTION.execute(performer, target, Args.EMPTY, world);
		
		assertEquals(1, world.getWorldObjects().size());
		assertEquals("palm tree", world.getWorldObjects().get(0).getProperty(Constants.NAME));
	}
