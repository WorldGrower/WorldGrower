...
public class UTestReduceAction {
	...
	public void testExecute() {
		...
		assertEquals(true, performer.getProperty(Constants.CONDITIONS).hasCondition(Condition.REDUCED_CONDITION));
	}
	...
	public void testDistance() {
		...
		assertEquals(0, Actions.REDUCE_ACTION.distance(performer, target, Args.EMPTY, world));
	}
