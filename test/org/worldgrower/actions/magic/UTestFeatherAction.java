...
public class UTestFeatherAction {
	...
	public void testIsActionPossible() {
		...
		assertEquals(true, Actions.FEATHER_ACTION.isActionPossible(performer, target, Args.EMPTY, world));
	}
	...
	public void testDistance() {
		...
		assertEquals(0, Actions.FEATHER_ACTION.distance(performer, target, Args.EMPTY, world));
	}
