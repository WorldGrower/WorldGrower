...
public class UTestSilenceMagicAction {
	...
	public void testExecute() {
		...
		Actions.SILENCE_MAGIC_ACTION.execute(performer, target, Args.EMPTY, world);
	...
	public void testIsActionPossible() {
		...
		assertEquals(true, Actions.SILENCE_MAGIC_ACTION.isActionPossible(performer, target, Args.EMPTY, world));
	}
