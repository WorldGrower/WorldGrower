...
public class UTestProtectionFromFireAction {
	...
	private final ProtectionFromFireAction action = Actions.PROTECTION_FROM_FIRE_ACTION;
	...
	public void testExecute() {
		...
		assertEquals(true, performer.getProperty(Constants.CONDITIONS).hasCondition(Condition.PROTECTION_FROM_FIRE_CONDITION));
	}
