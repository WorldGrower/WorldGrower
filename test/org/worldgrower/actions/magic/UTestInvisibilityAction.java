...
public class UTestInvisibilityAction {
	...
	public void testIsValidTarget() {
		...
		performer.setProperty(Constants.KNOWN_SPELLS, Arrays.asList(Actions.INVISIBILITY_ACTION));
		assertEquals(true, Actions.INVISIBILITY_ACTION.isValidTarget(performer, target, world));
		
		performer.setProperty(Constants.KNOWN_SPELLS, new ArrayList<>());
		assertEquals(false, Actions.INVISIBILITY_ACTION.isValidTarget(performer, target, world));
	}
