...
public class UTestSleepMagicAction {
	...
	public void testExecute() {
		...
		Actions.SLEEP_MAGIC_SPELL_ACTION.execute(performer, target, new int[0], world);
	...
	public void testDistance() {
		...
		assertEquals(0, Actions.SLEEP_MAGIC_SPELL_ACTION.distance(performer, target, new int[0], world));
	}
