...
public class UTestPlantCottonPlantAction {
	...
	public void testExecute() {
		...
		Actions.PLANT_COTTON_PLANT_ACTION.execute(performer, target, Args.EMPTY, world);
	...
	public void testDistance() {
		...
		assertEquals(0, Actions.PLANT_COTTON_PLANT_ACTION.distance(performer, target, Args.EMPTY, world));
	}
