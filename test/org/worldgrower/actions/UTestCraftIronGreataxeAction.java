...
public class UTestCraftIronGreataxeAction {
	...
	public void testIsValidTarget() {
		...
		assertEquals(false, Actions.CRAFT_IRON_GREATAXE_ACTION.isValidTarget(performer, performer, world));
		assertEquals(true, Actions.CRAFT_IRON_GREATAXE_ACTION.isValidTarget(performer, target, world));
	}
