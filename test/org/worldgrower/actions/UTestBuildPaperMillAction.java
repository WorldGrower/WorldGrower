...
public class UTestBuildPaperMillAction {
	...
	public void testIsValidTarget() {
		...
		assertEquals(true, Actions.BUILD_PAPER_MILL_ACTION.isValidTarget(performer, target, world));
	}
	...
	public void testIsActionPossible() {
		...
		assertEquals(true, Actions.BUILD_PAPER_MILL_ACTION.isActionPossible(performer, target, Args.EMPTY, world));
	}
