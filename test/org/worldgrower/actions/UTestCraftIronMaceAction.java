...
public class UTestCraftIronMaceAction {
	...
	public void testIsValidTarget() {
		...
		assertEquals(true, Actions.CRAFT_IRON_MACE_ACTION.isValidTarget(performer, performer, world));
		assertEquals(false, Actions.CRAFT_IRON_MACE_ACTION.isValidTarget(performer, target, world));
	}
