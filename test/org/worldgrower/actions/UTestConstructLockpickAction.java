...
public class UTestConstructLockpickAction {

	private ConstructLockpickAction action = Actions.CONSTRUCT_LOCKPICK_ACTION;
	...
	public void testExecute() {
		...
		assertEquals(1, performer.getProperty(Constants.INVENTORY).getQuantityFor(Constants.LOCKPICK_QUALITY));
	}
