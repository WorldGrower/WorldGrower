...
public class UTestWeaveCottonGlovesAction {

	@Test
	public void testExecute() {
		World world = new WorldImpl(1, 1, null, null);
		WorldObject performer = TestUtils.createSkilledWorldObject(2, Constants.INVENTORY, new WorldObjectContainer());
		Actions.WEAVE_COTTON_GLOVES_ACTION.execute(performer, performer, Args.EMPTY, world);
	...
	public void testIsValidTarget() {
		...
		assertEquals(true, Actions.WEAVE_COTTON_GLOVES_ACTION.isValidTarget(performer, target, world));
	}
	...
	public void testIsActionPossible() {
		...
		assertEquals(true, Actions.WEAVE_COTTON_GLOVES_ACTION.isActionPossible(performer, target, Args.EMPTY, world));
	}
