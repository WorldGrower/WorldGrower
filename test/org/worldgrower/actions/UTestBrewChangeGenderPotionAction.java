...
public class UTestBrewChangeGenderPotionAction {

	private BrewChangeGenderPotionAction action = Actions.BREW_CHANGE_GENDER_POTION_ACTION;
	...
	public void testExecute() {
		...
		assertEquals(5, performerInventory.getQuantityFor(Constants.OIL));
		assertEquals(1, performerInventory.getQuantityFor(Constants.CHANGE_GENDER));
	}
