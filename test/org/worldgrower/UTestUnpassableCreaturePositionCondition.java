...
public class UTestUnpassableCreaturePositionCondition {

	private UnpassableCreaturePositionCondition creaturePositionCondition = new UnpassableCreaturePositionCondition(4, 4);
	...
	@Test
	public void testIsWorldObjectValidBasicPassable() {
		WorldObject w1 = createWorldObject(4, 4, 1, 1);
		w1.setProperty(Constants.PASSABLE, Boolean.TRUE);
		assertFalse(creaturePositionCondition.isWorldObjectValid(w1));
	}
}
