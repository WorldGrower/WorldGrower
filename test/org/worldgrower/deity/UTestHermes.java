...
public class UTestHermes {
	...
	private Hermes deity = Deity.HERMES;
	...
	public void testWorship() {
		...
		assertEquals(0, performer.getProperty(Constants.LIGHT_ARMOR_SKILL).getLevel(performer));
		deity.worship(performer, target, 4, world);
		assertEquals(0, performer.getProperty(Constants.LIGHT_ARMOR_SKILL).getLevel(performer));
		deity.worship(performer, target, 5, world);
		
		assertEquals(2, performer.getProperty(Constants.LIGHT_ARMOR_SKILL).getLevel(performer));
	}
