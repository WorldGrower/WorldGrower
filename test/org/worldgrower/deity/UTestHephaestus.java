...
public class UTestHephaestus {
	...
	private Hephaestus deity = Deity.HEPHAESTUS;
	...
	public void testWorship() {
		...
		assertEquals(0, performer.getProperty(Constants.SMITHING_SKILL).getLevel(performer));
	...
	public void testOnTurn() {
		...
		WorldObject oreResource = world.findWorldObjectById(oreResourceId);
		...
		assertEquals(0, oreResource.getProperty(Constants.HIT_POINTS).intValue());
	}
