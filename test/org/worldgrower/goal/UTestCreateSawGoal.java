...
public class UTestCreateSawGoal {

	private CreateSawGoal goal = Goals.CREATE_SAW_GOAL;
	...
	public void testCalculateGoalConstructButherKnife() {
		...
		assertEquals(Actions.CONSTRUCT_SAW_ACTION, goal.calculateGoal(performer, world).getManagedOperation());
	}
	...
	public void testGetDescription() {
		assertEquals("looking for a saw", DefaultConversationFormatter.FORMATTER.format(goal.getDescription()));
	}
