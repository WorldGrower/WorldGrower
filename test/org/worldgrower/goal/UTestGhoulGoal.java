...
public class UTestGhoulGoal {
	...
	public void testCalculateGoalNull() {
		...
		assertEquals(Actions.CREATE_HUMAN_MEAT_ACTION, goal.calculateGoal(performer, world).getManagedOperation());
	}
	
	@Test
	public void testCalculateGoalOneHitPoint() {
		World world = new WorldImpl(1, 1, null, null);
		WorldObject organization = GroupPropertyUtils.create(null, "TestOrg", world);
		WorldObject performer = createCommoner(world, organization);
	...
	@Test
	public void testCalculateGoalSellHumanMeat() {
	...
	public void testIsGoalMet() {
		...
		WorldObject ghoul = createCommoner(world, organization);
		GhoulUtils.ghoulifyPerson(ghoul, world);
