...
public class UTestLegalActionsPropertyUtils {
	...
	public void testLegalActionsToArgs() {
		...
		int[] legalActionsToArgs = LegalActions.createGovernanceArgs(legalFlagsMap, 1, 2, 5, 5, false, false, false, false, 300, 300);
		assertEquals(12, legalActionsToArgs.length);
