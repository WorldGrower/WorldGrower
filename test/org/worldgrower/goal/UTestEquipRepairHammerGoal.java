...
public class UTestEquipRepairHammerGoal {

	private EquipRepairHammerGoal goal = Goals.EQUIP_REPAIR_HAMMER_GOAL;
	...
	@Test
	public void testCalculateGoalEquipRepairHammer() {
		World world = new WorldImpl(10, 10, null, null);
		WorldObject performer = createPerformer();
	...
	public void testGetDescription() {
		assertEquals("equipping a smithing hammer", DefaultConversationFormatter.FORMATTER.format(goal.getDescription()));
	}
