...
public class UTestEquipSawGoal {

	private EquipSawGoal goal = Goals.EQUIP_SAW_GOAL;
	...
	public void testCalculateGoalEquipButcherKnife() {
		World world = new WorldImpl(10, 10, null, null);
		WorldObject performer = createPerformer();
		performer.getProperty(Constants.INVENTORY).addQuantity(Item.SAW.generate(1f), 20);
	...
	public void testIsGoalMet() {
		...
		performer.getProperty(Constants.INVENTORY).addQuantity(Item.SAW.generate(1f), 10);
	...
	public void testGetDescription() {
		assertEquals("equipping a saw", DefaultConversationFormatter.FORMATTER.format(goal.getDescription()));
	}
