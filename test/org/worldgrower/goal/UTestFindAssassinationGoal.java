...
public class UTestFindAssassinationGoal {

	private FindAssassinationClientGoal goal = Goals.FIND_ASSASSINATION_CLIENT_GOAL;
	...
	@Test
	public void testCalculateGoalTalkToAssassinationClient() {
		World world = new WorldImpl(0, 0, null, null);
		WorldObject organization = GroupPropertyUtils.create(null, "TestOrg", world);
		WorldObject performer = createCommoner(world, organization);
		...
		performer.getProperty(Constants.RELATIONSHIPS).incrementValue(target, 200);
	...
	public void testIsGoalMet() {
		...
		performer.setProperty(Constants.ASSASSINATE_TARGET_ID, target.getProperty(Constants.ID));
