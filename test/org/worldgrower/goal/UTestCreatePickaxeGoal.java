...
public class UTestCreatePickaxeGoal {

	private CreatePickaxeGoal goal = Goals.CREATE_PICKAXE_GOAL;
	...
	@Test
	public void testCalculateGoalConstructPickaxe() {
		World world = new WorldImpl(10, 10, null, null);
		WorldObject performer = createPerformer();
		performer.getProperty(Constants.INVENTORY).addQuantity(Item.WOOD.generate(1f), 20);
		...
		assertEquals(Actions.CONSTRUCT_PICK_AXE_ACTION, goal.calculateGoal(performer, world).getManagedOperation());
	}
