...
public class UTestCreateButcherKnifeGoal {

	private CreateButcherKnifeGoal goal = Goals.CREATE_BUTCHER_KNIFE_GOAL;
	...
	public void testCalculateGoalConstructButherKnife() {
		...
		assertEquals(Actions.CONSTRUCT_BUTCHER_KNIFE_ACTION, goal.calculateGoal(performer, world).getManagedOperation());
	}
	...
	public void testGetDescription() {
		assertEquals("looking for a butcher knife", DefaultConversationFormatter.FORMATTER.format(goal.getDescription()));
	}
