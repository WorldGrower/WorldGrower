...
public class UTestEquipButcherKnifeGoal {

	private EquipButcherKnifeGoal goal = Goals.EQUIP_BUTCHER_KNIFE_GOAL;
	...
	@Test
	public void testCalculateGoalEquipButcherKnife() {
		World world = new WorldImpl(10, 10, null, null);
		WorldObject performer = createPerformer();
		performer.getProperty(Constants.INVENTORY).addQuantity(Item.BUTCHER_KNIFE.generate(1f), 20);
	...
	public void testIsGoalMet() {
		...
		performer.getProperty(Constants.INVENTORY).addQuantity(Item.BUTCHER_KNIFE.generate(1f), 10);
	...
	public void testGetDescription() {
		assertEquals("equipping a butcher knife", DefaultConversationFormatter.FORMATTER.format(goal.getDescription()));
	}
