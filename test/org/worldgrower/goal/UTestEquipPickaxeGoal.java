...
public class UTestEquipPickaxeGoal {

	private EquipPickaxeGoal goal = Goals.EQUIP_PICKAXE_GOAL;
	...
	@Test
	public void testCalculateGoalEquipPickaxe() {
		World world = new WorldImpl(10, 10, null, null);
		WorldObject performer = createPerformer();
		performer.getProperty(Constants.INVENTORY).addQuantity(Item.PICKAXE.generate(1f), 20);
	...
	public void testGetDescription() {
		assertEquals("equipping a pickaxe", DefaultConversationFormatter.FORMATTER.format(goal.getDescription()));
	}
