...
public class UTestConversations {
	...
	public void testCreateArgs() {
		assertArrayEquals(new int[] {0, -1, -1}, Conversations.createArgs(Conversations.NAME_CONVERSATION));
		assertArrayEquals(new int[] {0, 2, -1}, Conversations.createArgs(Conversations.NAME_CONVERSATION, TestUtils.createWorldObject(2, "testworldobject")));
		assertArrayEquals(new int[] {0, -1, 3}, Conversations.createArgs(Conversations.NAME_CONVERSATION, new HistoryItem(3, null, new Turn())));
	}
	...
	public void testGetReplyPhrase() {
		Response response = conversations.getReplyPhrase(0, -1, -1, performer, target, world);
