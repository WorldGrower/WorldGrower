...
public class UTestCanCollectTaxesConversation {
	...
	public void testGetReplyPhrases() {
		...
		assertEquals("Yes, you may collect taxes", replyPhrases.get(0).getResponsePhrase(DefaultConversationFormatter.FORMATTER));
		assertEquals("No, you may not collect taxes", replyPhrases.get(1).getResponsePhrase(DefaultConversationFormatter.FORMATTER));
	}
