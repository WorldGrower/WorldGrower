...
public class UTestJoinPerformerOrganizationConversation {

	private final JoinPerformerOrganizationConversation conversation = Conversations.JOIN_PERFORMER_ORGANIZATION_CONVERSATION;
	...
	public void testGetReplyPhrases() {
		...
		assertEquals("Yes, I'll join the TestOrg", replyPhrases.get(0).getResponsePhrase());
	...
	public void testHandleResponse0() {
		...
		assertEquals(Arrays.asList(), target.getProperty(Constants.GROUP).getIds());
		
		conversation.handleResponse(0, context);
		assertEquals(Arrays.asList(3), target.getProperty(Constants.GROUP).getIds());
	}
}
