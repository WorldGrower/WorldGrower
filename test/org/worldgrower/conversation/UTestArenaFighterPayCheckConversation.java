...
public class UTestArenaFighterPayCheckConversation {
	...
	public void testGetReplyPhrases() {
		...
		assertEquals("yes, here is your 50 gold", replyPhrases.get(0).getResponsePhrase(DefaultConversationFormatter.FORMATTER));
	...
	public void testGetReplyPhrase() {
		...
		World world = new WorldImpl(worldDimension, worldDimension, new DungeonMaster(worldDimension, worldDimension), null);
