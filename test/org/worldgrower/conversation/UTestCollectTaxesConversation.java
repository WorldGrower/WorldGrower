...
public class UTestCollectTaxesConversation {
	...
	public void testGetReplyPhrases() {
		...
		assertEquals("Yes, I'll pay my taxes", replyPhrases.get(0).getResponsePhrase(DefaultConversationFormatter.FORMATTER));
		assertEquals("No, I won't pay my taxes", replyPhrases.get(1).getResponsePhrase(DefaultConversationFormatter.FORMATTER));
	}
